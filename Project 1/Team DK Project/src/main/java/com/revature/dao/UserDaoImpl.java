...
public class UserDaoImpl implements UserDao {
	...
	public void updateUserL(User u) {
		...
		try (Connection conn = ConnectionUtil.getConectionProperties()) {
			...
			// declare sql statement + arguments
			String sql1 = "Update Web_Users Set User_Name=?, Pass_Word=?, Email=? Where User_ID=?";
	...
	public void updateUserI(User u) {
		...
		try (Connection conn = ConnectionUtil.getConectionProperties()) {
			...
			// declare sql statement + arguments
			String sql1 = "Update Web_Users Set First_Name=?, M_Intial=?, Last_Name=?, Ur_ID=? Where User_ID=?;";
			...
			pStmt1.setString(3, l);
			pStmt1.setInt(4, ur_id);
			pStmt1.setInt(5, uid);
